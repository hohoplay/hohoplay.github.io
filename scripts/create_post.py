...
_CONNECT_MAP = [
    ("양자리",   "용띠",    "시작",
     "양자리인 당신이 최근 뭔가 시작하고 싶은 마음만 계속 품고 있었다면, "
    ...
    ("쌍둥이자리","토끼띠",  "연결",
     ...
     "말 많은 쌍둥이자리 옆에서 토끼띠가 '그거 하나만 해'라고 조용히 말해주는 역할을 하는 날이에요. "
     "<br><br>"
    ...
    ("사자자리", "원숭이띠", "존재감",
     ...
     "열심히 했는데 아무도 알아채지 못하면 그 억울함이 이만저만이 아니죠. "
    ...
    ("천칭자리", "개띠",    "관계",
     ...
     "<br><br>"
     "거창하게 말할 필요 없어요. '그때 그 말이 조금 걸렸어'라고 짧게만 해도 충분해요. "
    ...
    ("물고기자리","양띠",   "쉬어가기",
     ...
     "오늘 양띠의 부드러운 에너지가 그 짐을 잠깐 내려놓게 해줍니다. "
