...
def birth_year_fortune(en_name, year):
    ...
    _FORTUNE_BY_YEAR = {
        ...
        # 개띠
        1946: "신뢰를 바탕으로 한 관계가 빛을 발하는 시기입니다.",
        1958: "오래된 인연에서 따뜻한 에너지를 얻는 흐름입니다.",
        1970: "정직하게 표현하는 것이 관계를 더 단단하게 만들어줍니다.",
        1982: "책임감이 좋은 결과로 이어지는 시기입니다.",
        1994: "신뢰하는 사람에게 마음을 한 번 열어보시기 바랍니다.",
        2006: "충직한 태도가 주변의 신뢰를 얻는 흐름입니다.",
        2018: "가까운 사람들과 함께하는 시간이 에너지를 채워줍니다.",
        # 돼지띠
...
def build_chinese_post(c, today_str):
    ...
    _YEAR_ACTION_TIPS = {
        ...
        'dog':      ["믿는 사람에게 먼저 연락해보는 것도 좋은 방법입니다.",
                     "의리를 지키는 태도가 장기적으로 더 큰 신뢰를 만들어줍니다.",
                     "솔직한 한마디가 관계를 더 단단하게 만들어줄 수 있습니다.",
                     "주변을 지키는 역할이 자연스럽게 맡겨지는 시기일 수 있습니다.",
                     "함께하는 쪽이 혼자보다 훨씬 든든할 수 있습니다.",
                     "충직한 태도, 오늘은 그것이 가장 큰 설득력이 되어줍니다.",
                     "팀을 위한 한 가지를 먼저 해보는 것도 괜찮은 선택입니다."],
...
<div style="font-family:'Noto Serif KR',Georgia,serif;max-width:660px;margin:0 auto">
  ...
  <div style="font-size:15px;line-height:2.1;color:#374151;
    ...
    <p style="margin:0 0 1.4em 0">
      ...
      {best_compat[2]} 반면 <span style="font-weight:700;color:#991b1b">{avoid_compat[1]} {avoid_compat[0]}</span>와는
      {avoid_compat[2]}
    </p>
