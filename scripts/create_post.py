...
_Z_LOVE_DETAIL_WARN = [
    "오늘 상대에게 서운한 것이 생기더라도, 그 자리에서 바로 꺼내지 마시기 바랍니다. 감정이 가라앉은 저녁 이후에 '그때 그 말이 조금 걸렸어'라고 차분하게 전하는 것이 훨씬 효과적입니다.",
    "오늘 문자나 메시지를 보내기 전에 한 번 더 읽어보시기 바랍니다. 내 의도와 다르게 읽힐 수 있는 표현이 있는지 확인한 다음 보내는 것이 오늘만큼은 중요합니다.",
    "혼자 있는 시간을 강제로 채우려 하지 마시기 바랍니다. 오늘 억지로 연락하거나 만남을 만들어내는 것보다 잠깐 거리 두는 것이 관계에 더 좋은 날입니다.",
    "오늘 상대방이 이상하게 느껴진다면, 상대가 이상한 것이 아니라 내 상태가 예민한 것일 수도 있습니다.\n\n먼저 내 감정을 확인해 보시기 바랍니다.",
    "상대 말투가 평소보다 조금 차갑게 느껴지는 순간이 올 수 있습니다. 그 말투가 진짜 의도인지 지금 그 사람 상태인지 먼저 확인하고 반응하시기 바랍니다. 오해로 번지기 전에 잡는 것이 훨씬 쉽습니다.",
...
_Z_MONEY_INTRO_UP = [
    ...
    "오늘 금전 관련 연락이나 제안이 들어온다면 내일로 미루지 마시기 바랍니다. 확인하고 결정하기에 오늘이 더 유리한 흐름입니다. 단, 서두르지 않아도 됩니다. 오늘 안에 판단하면 충분합니다.",
...
# ── 금전운 상세 조언 풀 ──
_Z_MONEY_DETAIL_UP = [
    "미뤄두었던 환급금이나 포인트 전환, 캐시백 신청을 오늘 처리하시기 바랍니다. 귀찮아서 미뤘던 것들이 오늘 손에 잡히는 날입니다. 10분만 투자해도 상당히 챙겨집니다.",
...
_Z_MONEY_DETAIL_WARN = [
    "오늘 오후 3시 이후에 쇼핑 앱을 열고 싶어진다면 알림을 끄시기 바랍니다. 지금 사고 싶은 것이 내일도 사고 싶으면 그때 사시기 바랍니다. 오늘 충동구매는 내일 아침 후회가 됩니다.",
...
_Z_MONEY_TIME_UP = [
    ...
    "💰 오늘 오후 2시~4시 사이가 수익 관련 아이디어가 가장 활발히 떠오르는 시간입니다. 생각이 떠오르면 바로 메모해 두시기 바랍니다.",
]
_Z_MONEY_TIME_WARN = [
    "💰 오늘 오후 3시 이후에는 지출 충동이 커집니다. 이 시간대에는 쇼핑 앱 알림을 꺼두고, 불필요한 온라인 쇼핑은 내일로 미루시기 바랍니다.",
    "💰 점심 이후부터 금전 판단력이 흐려질 수 있습니다. 중요한 계약이나 결제는 오전 안으로 처리하거나 다음 날로 넘기시기 바랍니다.",
]

# ── 금전운 마무리 풀 ──
_Z_MONEY_CLOSE_UP = [
    "오늘 챙긴 작은 것들이 모여서 단단한 기반이 됩니다. 들어오는 흐름일 때 지출도 같이 점검하는 것이 진짜 재테크입니다. 💛",
    "좋은 흐름일 때 가장 해야 할 건 흥청망청이 아니라 현명한 다음 준비입니다. 오늘 그 준비 하나만 해두시기 바랍니다. 🌟",
]
_Z_MONEY_CLOSE_WARN = [
...
_Z_WORK_SCORE_WARN = [
    "오늘은 억지로 성과 내려 하기보다 기존에 하던 것 점검하는 날로 쓰시기 바랍니다. 이런 날 무리하면 실수가 나옵니다.",
...
_Z_WORK_DETAIL_WARN = [
    ...
    "동료와 의견이 엇갈리는 순간이 오면, 내 주장을 밀어붙이기 전에 '그 방식은 어떤 이유에서인갑니다?'를 먼저 물어보시기 바랍니다. 오늘 그 한 마디가 갈등을 만들지 않는 열쇠입니다.",
    "중요한 발표나 보고가 오늘로 잡혀 있다면 준비가 조금 더 필요하다고 느껴질 수 있습니다. 그 느낌이 맞습니다. 오늘 오전 안에 한 번 더 점검해 두시기 바랍니다.",
    "오늘 상사나 동료 말투가 유독 날카롭게 느껴지는 순간이 있을 수 있습니다. 그 말투가 나를 향한 건지, 그 사람 상태가 안 좋은 건지 구분하고 반응하시기 바랍니다. 불필요한 감정 소모를 줄여줍니다.",
    "눈치 보느라 못 했던 의견이 있다면 오늘은 메일로 짧게라도 남겨두시기 바랍니다. 말로 꺼내기 어려우면 문서가 대신해줍니다.",
]
...
# ── 직장운 마무리 풀 ──
_Z_WORK_CLOSE_UP = [
    "오늘 만들어낸 작은 성과 하나가 나중에 기회의 문을 여는 열쇠가 됩니다. 오늘 하루도 수고 많으셨습니다. 🌟",
    "남들 눈에 안 보이는 데서 해온 것들이 오늘 조금씩 보이기 시작합니다. 그게 쌓인 거입니다. 💼",
]
_Z_WORK_CLOSE_WARN = [
    "쉽지 않은 날이었을 거입니다. 그래도 오늘 하루 버텨낸 것, 정말 잘하셨습니다. 내일은 다를 거입니다. 🌿",
    "모든 날이 빛날 수는 없습니다. 오늘 같은 날이 있어야 좋은 날의 가치가 더 크게 느껴집니다. 오늘은 충분히 쉬어가시기 바랍니다. 💙",
]
_Z_AVOID_ACTIONS = [
...
def zodiac_weekly_fortune(kr_name):
    """주간 운세 CSV에서 가져오기 — zodiac_weekly_1000.csv (요일별 나열을 산문으로 변환)"""
    if not zodiac_weekly.empty and 'zodiac' in zodiac_weekly.columns:
        ...
        if not m.empty:
            ...
            seed = kst.month * 100 + kst.day
            idx = seed % len(m)
            text = str(m.iloc[idx]['fortune'])
            return _weekly_to_prose(text)
    return sentence()

def _weekly_to_prose(text):
    """'월요일 — ...' 식 요일별 나열을 자연스러운 산문으로 재구성"""
    # 먼저 \n\n으로 큰 단위 분리, 그 안의 \n은 요일별 줄
    ...
    for block in blocks[1:]:
        rest_lines += [l.strip() for l in block.split('\n') if l.strip()]

    if not rest_lines:
        return intro

    # 요일별 줄을 "월요일에는 ~." 형태의 산문으로 연결
    day_sentences = []
    for line in rest_lines:
        if '—' in line:
            ...
            day_sentences.append(f"{day}에는 {content}")
        else:
            day_sentences.append(line)

    body = " ".join(day_sentences)
    body = _to_formal(body)
    # "월요일에는 오늘은..." 같은 중복 표현 정리
    body = re.sub(r'(월요일|화요일|수요일|목요일|금요일|토요일|일요일)에는 오늘은', r'\1에는', body)
    body = re.sub(r'(월요일|화요일|수요일|목요일|금요일|토요일|일요일)에는 이번 주', r'\1에는 이번 주', body)
    return f"{intro}<br><br>{body}"
