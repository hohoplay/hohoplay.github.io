...
def build_quote_post(today_str):
    ...
    _QUOTE_H2_BRIDGES = [
        ...
        f"{author_ko}가 남긴 이 말이 오늘 당신에게 가장 필요한 문장일 수 있습니다.",
...
<div class="wrap">
  ...
  <div id="{card_id}" class="qc-page">
    ...
    <!-- 서재 브릿지 -->
    <p style="font-size:13px;color:#6b7280;margin:1.6rem 0 0.4rem;
              line-height:1.9;word-break:keep-all">{library_txt}</p>
