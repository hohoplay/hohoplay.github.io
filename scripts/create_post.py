...
_CONNECT_MAP = [
    ("양자리",   "용띠",    "시작",
     "양자리랑 용띠, 오늘 비슷한 에너지 위에 서 있어요. "
     "둘 다 시작하고 싶은 마음은 있는데 첫 발 앞에서 이상하게 멈추는 날이에요. "
     "그게 두려움이 아니에요. 에너지가 너무 커서 어디서 터뜨릴지 아직 못 고른 거거든요. "
     "<br><br>"
     "오늘 지금 바로 할 수 있는 것: 파일 하나를 열거나, 메시지 초안을 쓰거나. "
     "완성이 아니라 열기만 해도 돼요. 그 한 발이 오늘의 전부예요."),
    ("황소자리", "뱀띠",    "결실",
     "황소자리와 뱀띠는 오늘 둘 다 이거 언제 보여지나 하는 날이에요. "
     "열심히 쌓아온 건 있는데 아직 눈에 보이지 않는 그 답답함이요. "
     "근데 오늘이 그 쌓인 것들이 조금씩 수면 위로 올라오는 날이에요. "
     "<br><br>"
     "오늘 오후에 누군가의 반응 하나가 그 피로를 가볍게 만들어줄 수 있어요. "
     "작은 피드백이라도 흘려보내지 마세요. 그게 신호예요."),
    ("쌍둥이자리","토끼띠",  "연결",
     "쌍둥이자리와 토끼띠, 오늘 머릿속이 좀 많은 날이에요. "
     "이것도 신경 쓰이고, 저것도 해야 하고, 결국 아무것도 못 끝낸 느낌이 드는 그 날이요. "
     "오전엔 억지로 집중하려다 더 지치는 패턴이 나올 수 있어요. "
     "<br><br>"
     "이럴 때 쓰는 방법: 오늘 할 것 목록을 10개 적고 그 중 딱 2개만 남기세요. "
     "나머지 8개는 내일로 이동. 줄일수록 오늘 결과물이 좋아지는 날이에요."),
    ("게자리",   "말띠",    "용기",
     "게자리랑 말띠, 오늘 하고 싶은 말이 있는데 계속 삼키고 있지는 않으세요? "
     "말해봤자 뭐가 달라지나 싶어서, 분위기 이상해질까봐 그냥 넘기는 날들이 쌓였을 수도 있어요. "
     "<br><br>"
     "오늘은 그 말 꺼내기 가장 좋은 날이에요. "
     "거창하게 하지 않아도 됩니다. 문자 하나, 짧은 안부 하나. "
     "오후 3시 이후에 보내는 메시지가 오늘 가장 잘 닿는 시간이에요."),
    ("사자자리", "원숭이띠", "존재감",
     "사자자리와 원숭이띠, 오늘 좀 인정받고 싶은 날이에요. "
     "열심히 하는 건 알겠는데 아무도 모르는 것 같고, 그게 억울하게 느껴지는 날이요. "
     "<br><br>"
     "오늘 오전 안에 한 가지만 먼저 완성해서 공유해보세요. "
     "큰 것 아니어도 돼요. 작은 완성을 먼저 보여주는 사람이 오늘 가장 눈에 띄거든요. "
     "인정은 기다리는 게 아니라 먼저 보여주는 거예요."),
    ("처녀자리", "닭띠",    "완성",
     "처녀자리와 닭띠, 오늘 완벽하게 준비되지 않아서 못 내보내고 있는 게 있지 않으세요? "
     "80%에서 멈추는 게 아깝고, 그렇다고 100%가 언제 될지도 모르는 그 상태요. "
     "<br><br>"
     "오늘 이것만 기억하세요: 80%에서 내보내는 날이에요. "
     "오전 11시까지 한 가지를 완성하고 그냥 보내세요. 나머지 20%는 다음 버전에서 하면 돼요. "
     "완성이 완벽보다 오늘은 훨씬 중요합니다."),
    ("천칭자리", "개띠",    "관계",
     "천칭자리와 개띠, 마음속에서 은근히 서운한 게 하나쯤 있을 수 있어요. "
     "말로 꺼내기엔 애매하고, 그렇다고 그냥 넘기기엔 뭔가 걸리는 그거요. "
     "<br><br>"
     "오늘 저녁 7시 이후가 그 말을 꺼내기 가장 좋은 시간이에요. "
     "하루가 마무리되면서 감정이 안정되는 시간이거든요. "
     "거창하게 말할 필요 없어요. 그때 그 말이 조금 걸렸어라고 짧게만 해도 충분합니다."),
    ("전갈자리", "돼지띠",  "직관",
     "전갈자리와 돼지띠, 오늘 감이 잘 맞는 날이에요. "
     "특히 사람에 대한 감각이요. 별것 아닌 말 한마디, 표정 하나가 오늘은 묘하게 오래 남아요. "
     "<br><br>"
     "오늘 첫 번째로 떠오르는 판단을 믿어보세요. "
     "그 직감을 너무 분석하다 보면 오히려 정확도가 떨어지는 날이에요. "
     "밤 9시 이후 조용한 시간에 오늘 있었던 일을 되짚어 보면 낮에 못 봤던 게 보여요."),
    ("사수자리", "쥐띠",    "전환",
     "사수자리와 쥐띠, 요즘 갑갑한 느낌이 들 수 있어요. "
     "뭔가 바뀌고 싶은데 어디서 시작해야 할지 모르는 그 답답함이요. "
     "<br><br>"
     "오늘 딱 하나만 바꿔보세요. 출근 경로를 달리하거나, 점심 메뉴를 완전히 다른 것으로 하거나. "
     "아주 작은 변화가 오늘 흐름을 여는 신호가 돼요. "
     "낮 12시~오후 2시 사이가 그 전환 에너지가 가장 살아있는 시간이에요."),
    ("염소자리", "소띠",    "신뢰",
     "염소자리와 소띠, 오늘도 묵묵히 자기 길을 가는 날이에요. "
     "결과가 아직 안 보여서 이게 맞나 싶은 날일 수 있어요. "
     "주변에서 먼저 나아가는 것처럼 보이는 사람들이 유독 눈에 띄는 날이기도 하고요. "
     "<br><br>"
     "오늘 오전에 지금까지 해온 것들을 짧게 메모해보세요. "
     "5분이면 돼요. 눈에 안 보여도 쌓이고 있다는 걸 글로 확인하는 것만으로 오늘이 달라져요."),
    ("물병자리", "호랑이띠", "다름",
     "물병자리와 호랑이띠, 오늘 남들이랑 다른 방향이 자꾸 떠오르는 날이에요. "
     "맞춰야 할 것 같은데 맞추기 싫고, 그렇다고 혼자 튀기는 뭐한 그 자리요. "
     "<br><br>"
     "오늘 그 아이디어를 일단 메모해두세요. 공유는 내일, 실행은 모레여도 돼요. "
     "오후 3시~5시 사이가 창의적인 생각이 가장 선명하게 떠오르는 시간이에요. "
     "그때 10분만 혼자 조용히 앉아 써보세요."),
    ("물고기자리","양띠",   "쉬어가기",
     "물고기자리와 양띠, 요즘 사람들 기분을 다 받아내다가 정작 본인이 제일 지친 날들이 있었을 거예요. "
     "공감 잘하는 게 강점인데, 그게 오히려 짐이 되는 시기거든요. "
     "<br><br>"
     "오늘 저녁 8시 이후는 진짜 오프 타임으로 지켜보세요. "
     "핸드폰 알림을 끄고 30분만 아무것도 안 해도 돼요. "
     "손을 펴고 있을 때 좋은 것이 내려앉으니까요. 채우려 하지 않아도 되는 날이에요."),
]


_OMNIBUS_OPENINGS = [
    "오늘 별자리와 띠가 만나는 자리에서, 당신한테 하고 싶은 말이 있어요. "
    "길게 설명하지 않을게요. 대신 오늘 당장 쓸 수 있는 것들만 담았어요. "
    "각자의 이야기를 찾아서 읽어보세요.",

    "오늘 하루, 어떤 시간에 무엇을 하느냐가 생각보다 크게 달라질 수 있어요. "
    "별자리와 띠가 각자 오늘 가장 좋은 타이밍을 알고 있거든요. "
    "읽으면서 지금이 그 시간이네 싶은 순간이 오면 바로 움직이세요.",

    "운세를 믿지 않아도 괜찮아요. "
    "그냥 오늘 이 글이 맞아 나 요즘 이랬어가 되거나 "
    "지금 이거 해야겠다가 되면 충분하니까요. "
    "별자리와 띠가 오늘 하루를 어떻게 쓰면 좋을지 이야기해줄게요.",

    "오늘 당신의 별자리와 띠가 같은 시간대 위에 서 있어요. "
    "각자의 에너지가 어떻게 흘러가는지, "
    "그리고 그 흐름에서 오늘 가장 잘 맞는 행동이 뭔지 같이 읽어봐요.",

    "별자리와 띠는 각자 다른 리듬으로 오늘을 읽어요. "
    "그 두 리듬이 만나는 지점에서 오늘 하루의 힌트가 나와요. "
    "아래에서 본인 별자리와 띠의 이야기를 찾아보세요. "
    "읽고 나서 딱 한 가지만 실행해보세요.",
]

_OMNIBUS_CLOSINGS = [
    "오늘 읽은 것 중에 한 가지만 실행하면 충분해요. "
    "전부 다 하려면 아무것도 못 하거든요. "
    "딱 하나, 지금 바로 할 수 있는 것 하나만 골라서 해보세요. 오늘 하루 잘 마무리하세요.",

    "운세는 예언이 아니에요. "
    "지금 이 감각, 당신만 느끼는 게 아니에요라고 말해주는 거예요. "
    "오늘 딱 한 가지만 기억하고 가세요. 지금 충분히 잘 하고 있으니까요.",

    "오늘 여기까지 읽어줘서 고마워요. "
    "오늘 하루가 예상보다 잘 흘러가기를 바라요. "
    "시간대별로 움직여보면 오늘이 좀 다른 날이 될 수 있어요. 내일도 또 이야기 나눠요.",

    "좋은 흐름은 아는 사람한테 먼저 보여요. "
    "오늘 그 흐름을 알았으니, 이제 움직일 차례예요. "
    "작은 것 하나. 지금 바로. 그걸로 충분합니다.",

    "오늘 하루 어떤 시간에 무엇을 했는지가 내일을 만들어요. "
    "오늘 이 글이 그 선택에 조금이라도 도움이 됐으면 해요. "
    "오늘도 수고했어요. 내일도 잘 부탁해요.",
]
...
_TIME_POOL = [
    {"label": "오전 9시~11시",
     ...
     "action": "중요한 결정이나 오래 묵혀두던 작업을 이 시간에 처리하세요. 오후로 넘기면 에너지가 분산돼요.",
     "goal": "오전 9시에 오늘 끝내야 할 것 하나를 정해두고 시작하세요."},
    {"label": "오전 10시~낮 12시",
     "why": "뇌가 워밍업을 마치고 최고 속도로 돌아가는 시간대예요. 분석이 필요한 일, 글쓰기, 기획이 이 시간에 가장 잘 풀려요.",
     "action": "새로운 아이디어 정리, 기획서 초안, 오래 미뤄온 문서 작업을 이 시간에 하세요.",
     "goal": "오전 10시에 빈 문서를 열고 떠오르는 것부터 써보세요. 완성이 아니라 시작이 목표예요."},
    {"label": "오전 11시~오후 1시",
     "why": "하루의 흐름이 가장 안정적으로 유지되는 시간대예요. 오전의 집중력과 오후의 여유가 겹치는 구간이거든요.",
     "action": "협상이나 설득이 필요한 대화를 이 시간에 하세요. 상대방도 이 시간대가 비교적 여유로운 경우가 많아요.",
     "goal": "오전 11시에 오늘 가장 중요한 연락 하나를 보내거나 전화를 거세요."},
    {"label": "오후 1시~3시",
     "why": "점심 후 에너지가 재충전되면서 오후 집중력이 올라오는 시간이에요. 창의적인 판단이 이 시간에 가장 잘 나와요.",
     "action": "아이디어 정리, 새로운 방향 탐색, 오후 미팅 준비를 이 시간에 하세요.",
     "goal": "오후 1시에 오늘 남은 할 일 중 가장 중요한 것 하나를 골라 집중하세요."},
    {"label": "오후 2시~4시",
     "why": "주간 중 업무 추진력이 가장 높은 시간대예요. 사람들의 집중력이 다시 올라오고 결정이 빠르게 이뤄지는 구간이거든요.",
     "action": "협상, 부탁, 설득이 필요한 대화는 이 시간에 하세요. 타이밍이 결과를 바꿔요.",
     "goal": "오후 2시에 오늘의 핵심 연락 하나를 보내거나 전화 하나를 거세요."},
    {"label": "오후 3시~5시",
     "why": "하루의 피로가 아직 덜 쌓인 상태에서 대인관계 에너지가 올라오는 시간이에요. 대화가 자연스럽게 열리는 구간이거든요.",
     "action": "마무리 연락, 감사 메시지, 오늘 중 못 했던 말을 이 시간에 보내세요. 저녁으로 넘기면 타이밍을 놓쳐요.",
     "goal": "오후 3시에 연락하고 싶었던 사람 한 명에게 짧게 안부를 보내세요."},
    {"label": "오후 4시~6시",
     "why": "하루를 마무리하면서 감정과 생각이 정리되는 시간이에요. 중요한 것들이 선명해지는 구간이거든요.",
     "action": "오늘 한 일을 짧게 정리하고, 내일 해야 할 것 딱 3개만 적어두세요.",
     "goal": "오후 4시에 오늘 가장 잘 한 것 하나를 메모해두세요. 작은 성취가 내일을 만들어요."},
    {"label": "오후 5시~7시",
     "why": "퇴근 후 첫 두 시간은 하루 중 가장 자유로운 시간이에요. 억압 없이 자신이 원하는 것에 집중할 수 있는 구간이거든요.",
     "action": "오늘 하고 싶었는데 못 한 것을 이 시간에 하세요. 작은 것 하나라도 자신을 위해 쓰는 게 맞아요.",
     "goal": "오후 5시에 오늘 자신을 위한 것 하나를 시작하세요. 30분이면 충분해요."},
    {"label": "저녁 7시~9시",
     "why": "하루의 긴장이 풀리면서 진짜 하고 싶은 말이 나오는 시간이에요. 감정이 안정되면서 대화가 깊어지는 구간이거든요.",
     "action": "낮에 못 했던 중요한 대화를 오늘 저녁에 꺼내보세요. 지금이 가장 잘 닿는 타이밍이에요.",
     "goal": "저녁 7시에 오늘 하고 싶었던 말 하나를 꺼내보세요. 거창하게 아니어도 돼요."},
    {"label": "오전 7시~9시",
     "why": "하루를 여는 첫 두 시간이 그날의 흐름을 결정해요. 외부 방해가 없는 이른 시간에 집중하면 오전 전체가 달라지거든요.",
     "action": "오늘 가장 중요한 것 하나를 오전에 먼저 처리하세요. 나중으로 미루면 하루 내내 머릿속에 걸려요.",
     "goal": "오전 7시에 일어나 오늘의 한 가지를 정해두고 커피 한 잔부터 시작하세요."},
    {"label": "낮 12시~오후 2시",
     "why": "점심 시간은 하루의 피로를 리셋하는 골든타임이에요. 이 시간을 제대로 쓰면 오후가 완전히 달라지거든요.",
     "action": "오늘 점심은 제대로 먹고, 10분만 걸어보세요. 오후 집중력이 눈에 띄게 달라져요.",
     "goal": "낮 12시에 핸드폰을 내려두고 진짜 쉬는 점심 시간을 만들어보세요."},
    {"label": "오전 6시~8시",
     "why": "세상이 아직 조용한 이 시간, 자신만을 위한 공간이 생겨요. 이 시간에 한 가지를 시작하면 하루 전체가 달라지거든요.",
     "action": "오늘 아침 이른 시간에 하고 싶었던 것 하나를 시작해보세요. 짧아도 괜찮아요.",
     "goal": "오전 6시에 일어나 조용한 시간 속에서 오늘 하루를 어떻게 보낼지 5분만 생각해보세요."},
]

# 요일별 가이드는 기준으로만 사용, 실제 출력은 조합 idx로 풀에서 선택
_IMPROVED_TIME_GUIDE = {i: _TIME_POOL[i % len(_TIME_POOL)] for i in range(7)}
