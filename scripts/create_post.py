...
_IMPROVED_TIME_GUIDE = {
    0: {"label": "오전 10시~12시",
        "why": "주초에 집중력이 가장 살아있는 시간대예요. 뇌가 아직 피로를 덜 쌓은 상태라 판단이 가장 빠르게 나오거든요.",
        "action": "미뤄두던 이메일 하나, 중요한 결정 하나를 이 시간 안에 처리하세요. 오후로 넘기면 에너지가 분산돼요.",
        "goal": "오전 10시에 오늘 이것만큼은 끝낸다 파일 하나를 열어두세요."},
    1: {"label": "오후 2시~4시",
        "why": "화요일 오후는 주간 중 업무 추진력이 가장 높은 시간이에요. 월요일 정비가 끝나고 수요일 고비 전, 딱 중간 지점이거든요.",
        "action": "협상, 부탁, 설득이 필요한 대화는 이 시간에 하세요. 상대도 오후 화요일엔 비교적 여유로운 경우가 많아요.",
        "goal": "오후 2시에 오늘의 핵심 연락 하나를 보내거나 전화 하나를 거세요."},
    2: {"label": "오전 9시~11시",
        "why": "수요일 오전은 창의적 사고가 가장 활성화되는 시간이에요. 주 중반이라 긴장감과 여유가 균형을 이루는 시점이거든요.",
        "action": "새로운 아이디어 정리, 기획서 초안, 오래 묵혀두던 문서 작업을 이 시간에 하세요. 오후보다 두 배 빨리 써져요.",
        "goal": "오전 9시에 빈 문서 하나를 열고 떠오르는 것부터 써보세요. 완성이 아니라 시작이 목표예요."},
    3: {"label": "오전 10시~오후 1시",
        "why": "목요일은 주간 중 전체 에너지가 가장 높은 날이에요. 이 시간대에 중요한 결정을 내리면 주말 전 마무리가 훨씬 수월해져요.",
        "action": "이번 주 안에 결론 내야 하는 것들, 오늘 오전에 처리하세요. 금요일로 넘기면 주말까지 머릿속에 걸려요.",
        "goal": "오전 10시에 이번 주 미완성 목록을 꺼내고 하나만 선택해 집중하세요."},
    4: {"label": "오후 3시~6시",
        "why": "금요일 오후는 대인관계 에너지가 올라오는 시간이에요. 주말을 앞두고 사람들의 경계가 낮아지고 대화가 자연스럽게 열리거든요.",
        "action": "마무리 연락, 감사 메시지, 한 주간 못 했던 말을 오늘 오후에 보내세요. 주말 지나면 타이밍을 놓쳐요.",
        "goal": "오후 3시에 연락하고 싶었던 사람 한 명에게 짧게 안부를 보내세요."},
    5: {"label": "오전 7시~10시",
        "why": "토요일 이른 아침은 하루 에너지를 충전하는 골든타임이에요. 바쁜 평일과 달리 아무 방해 없이 자신만의 시간을 쓸 수 있는 유일한 시간대거든요.",
        "action": "오늘 하고 싶었던 것 하나, 해야 하는 것 하나를 오전에 끝내두세요. 오후엔 진짜 쉬어도 되도록요.",
        "goal": "오전 7시에 일어나 오늘의 한 가지를 메모해두고 커피 한 잔부터 시작하세요."},
    6: {"label": "오후 4시~7시",
        "why": "일요일 저녁은 내일을 위한 준비 골든타임이에요. 이 시간에 내일의 첫 1시간만 설계해두면 월요일 아침이 완전히 달라지거든요.",
        "action": "내일 해야 할 것 딱 3개만 적어두세요. 많이 적을수록 내일 아침 무거워져요. 3개가 딱 맞아요.",
        "goal": "오후 4시에 내일 파일 하나만 미리 열어두거나 메모 앱에 내일 할 일을 써두세요."},
}
