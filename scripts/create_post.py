...
def build_omnibus_post(today_str: str) -> tuple:
    ...
    _SPECIAL_ADVICE = {
        ...
        ("양자리","소띠"):    ("오늘따라 양자리의 시작 에너지가 소띠의 완성 에너지를 만납니다. 시작은 양자리가, 마무리는 소띠가 담당하는 최고의 조합입니다.", "지금이라면 양자리인 분은 먼저 제안하고, 소띠인 분은 그것을 구체화하는 역할을 나눠보시기 바랍니다."),
        ...
        ("양자리","닭띠"):    ("오늘따라 양자리의 속도에 닭띠의 꼼꼼함이 더해지는 날입니다. 빠르고 정확한 최고의 조합입니다.", "지금이라면 중요한 업무가 있다면 양자리가 추진하고 닭띠가 검토하는 방식으로 진행하시기 바랍니다."),
        ...
        # 황소자리
        ("황소자리","쥐띠"):  ("지금 이 흐름에서는 황소자리의 안정성과 쥐띠의 정보력이 결합하는 날입니다. 신중하게 정보를 모아 확실한 결정을 내리는 최고의 조합입니다.", "한번 이렇게 해보면 좋습니다. 큰 결정이 있다면 쥐띠의 정보와 황소자리의 판단을 결합해보시기 바랍니다."),
        ...
        ("황소자리","뱀띠"):  ("오늘따라 황소자리와 뱀띠, 두 신중한 에너지가 만납니다. 서두르지 않고 정확하게 가는 최고의 조합입니다.", "지금이라면 성급하게 결론을 내리지 말고 충분히 검토한 후 움직이시기 바랍니다."),
        ...
        ("쌍둥이자리","소띠"):("오늘따라 쌍둥이자리의 아이디어와 소띠의 실행력이 만납니다. 생각을 현실로 만드는 최고의 조합입니다.", "지금이라면 쌍둥이자리의 아이디어 중 하나를 골라 소띠와 함께 실행해보시기 바랍니다."),
        ("쌍둥이자리","호랑이띠"):("이 조합에서는 쌍둥이자리의 말과 호랑이띠의 행동이 만나는 날입니다. 말이 바로 행동으로 연결되는 강력한 조합입니다.", "함께 결정하고 바로 실행하시기 바랍니다. 망설이면 이 에너지가 분산됩니다."),
        ...
        ("게자리","양띠"):   ("이런 날엔 두 공감 에너지가 만납니다. 서로의 감정을 가장 잘 이해하는 최고의 조합입니다.", "이 조합이라면 힘든 것이 있다면 서로 털어놓기 가장 좋은 날입니다."),
        ...
        ("게자리","개띠"):   ("흥미롭게도 게자리의 따뜻함과 개띠의 충성심이 만납니다. 서로에 대한 신뢰가 더욱 깊어지는 날입니다.", "오늘이라면 오래된 인연에게 마음을 표현하기 가장 좋은 날입니다."),
        ...
        ("사자자리","소띠"):  ("오늘따라 사자자리의 화려함과 소띠의 꾸준함이 만납니다. 빛나면서도 흔들리지 않는 조합입니다.", "지금이라면 사자자리의 아이디어를 소띠가 현실적으로 구체화하면 최고의 결과가 나옵니다."),
        ...
        ("사자자리","용띠"):  ("지금 이 흐름에서는 두 최강 에너지가 만나는 날입니다. 함께라면 무엇이든 가능한 조합입니다.", "한번 이렇게 해보면 좋습니다. 함께 큰 목표를 향해 움직이기 가장 좋은 날입니다."),
        ...
        ("사자자리","닭띠"):  ("오늘따라 사자자리의 화려함과 닭띠의 꼼꼼함이 만납니다. 빛나면서도 실수가 없는 최고의 조합입니다.", "지금이라면 닭띠가 꼼꼼하게 준비한 것 위에서 사자자리가 빛나는 방식으로 진행하시기 바랍니다."),
        ("사자자리","개띠"):  ("이 조합에서는 사자자리의 리더십과 개띠의 충성심이 만납니다. 이끄는 자와 따르는 자가 완벽하게 맞는 날입니다.", "사자자리인 분이 방향을 제시하고 개띠인 분이 함께 움직이면 최고의 결과가 나옵니다."),
        ...
        ("처녀자리","소띠"):  ("가만히 보면, 두 성실한 에너지가 만납니다. 처녀자리와 소띠 모두 꾸준히 하는 것을 최고의 가치로 여기는 타입입니다.", "이럴 때는 함께 오래 걸리는 일을 시작하기 가장 좋은 날입니다."),
        ...
        ("처녀자리","용띠"):  ("처녀자리의 세밀함이 용띠의 큰 그림을 완성하는 날입니다.", "가능하다면 용띠의 비전을 처녀자리가 구체적으로 설계하면 최고의 결과가 나옵니다."),
        ...
        ("천칭자리","호랑이띠"):("이 조합에서는 천칭자리의 조화와 호랑이띠의 추진력이 만납니다. 부드럽게 이끄는 강력한 조합입니다.", "천칭자리가 방향을 제시하고 호랑이띠가 실행하면 최고의 결과가 나옵니다."),
        ...
        ("천칭자리","용띠"):  ("지금 이 흐름에서는 천칭자리의 균형과 용띠의 큰 그림이 만납니다. 공정하면서도 웅장한 에너지가 흐르는 날입니다.", "한번 이렇게 해보면 좋습니다. 용띠의 큰 아이디어를 천칭자리가 균형 있게 조율하면 최고의 결과가 나옵니다."),
        ...
        ("전갈자리","소띠"):  ("가만히 보면, 전갈자리의 깊이와 소띠의 꾸준함이 만납니다. 깊게 파고들면서도 끝까지 가는 조합입니다.", "이럴 때는 오래 걸리는 중요한 일에 함께 집중하기 가장 좋은 날입니다."),
        ...
        ("전갈자리","용띠"):  ("두 강력한 에너지가 같은 방향을 향하는 날입니다. 전갈자리의 통찰과 용띠의 카리스마가 결합하면 누구도 막을 수 없습니다.", "가능하다면 큰 목표를 향해 함께 움직이기 가장 좋은 날입니다."),
        ...
        ("전갈자리","닭띠"):  ("가만히 보면, 전갈자리의 통찰과 닭띠의 꼼꼼함이 만납니다. 깊이 보면서도 정확하게 마무리하는 최고의 조합입니다.", "이럴 때는 중요한 프로젝트를 함께 마무리하기 가장 좋은 날입니다."),
        ...
        # 사수자리
        ("사수자리","쥐띠"):  ("사수자리의 큰 그림과 쥐띠의 정보력이 만납니다. 방향은 사수자리가, 정보는 쥐띠가 담당하는 최고의 조합입니다.", "가능하다면 함께 새로운 가능성을 탐색하기 가장 좋은 날입니다."),
        ("사수자리","소띠"):  ("오늘따라 사수자리의 모험심과 소띠의 꾸준함이 만납니다. 크게 꿈꾸면서도 착실하게 실현하는 조합입니다.", "지금이라면 사수자리의 큰 목표를 소띠가 단계적으로 실현하는 계획을 세워보시기 바랍니다."),
        ("사수자리","호랑이띠"):("이 조합에서는 두 자유로운 에너지가 만나는 날입니다. 사수자리와 호랑이띠 모두 앞으로 나아가는 힘이 강한 최고의 조합입니다.", "함께 새로운 것을 시작하면 그 어떤 날보다 강력한 에너지가 만들어집니다."),
        ...
        ("사수자리","닭띠"):  ("오늘따라 사수자리의 큰 그림과 닭띠의 꼼꼼함이 만납니다. 비전이 정확하게 실현되는 날입니다.", "지금이라면 사수자리가 방향을 제시하고 닭띠가 세부 계획을 세우면 최고의 결과가 나옵니다."),
        ("사수자리","개띠"):  ("이 조합에서는 사수자리의 자유와 개띠의 충성심이 만납니다. 자유롭게 움직이면서도 서로를 믿는 조합입니다.", "서로에 대한 믿음을 바탕으로 각자의 방향으로 움직여도 결국 같은 곳에 만나는 날입니다."),
        ("사수자리","돼지띠"):("이런 날엔 사수자리의 낙관성과 돼지띠의 낙천성이 만납니다. 두 긍정 에너지가 결합하면 어떤 상황도 좋게 바뀝니다.", "이 조합이라면 함께 있으면 주변 모두가 행복해지는 최고의 조합입니다."),
        # 염소자리
        ("염소자리","쥐띠"):  ("지금 이 흐름에서는 염소자리의 목표 지향성과 쥐띠의 정보력이 만납니다. 정확한 정보를 바탕으로 목표를 향해 나아가는 최고의 조합입니다.", "한번 이렇게 해보면 좋습니다. 쥐띠의 정보를 활용해서 염소자리의 목표를 더 빠르게 달성하는 방법을 찾아보시기 바랍니다."),
        ("염소자리","소띠"):  ("가만히 보면, 두 성실한 에너지가 만납니다. 염소자리와 소띠 모두 꾸준히 해야 이루는 것이 최고의 성취임을 아는 타입입니다.", "이럴 때는 장기적인 목표를 함께 점검하기 가장 좋은 날입니다."),
        ("염소자리","호랑이띠"):("흥미롭게도 염소자리의 꾸준함과 호랑이띠의 추진력이 만납니다. 안정적으로 빠르게 가는 최고의 조합입니다.", "오늘이라면 호랑이띠가 시작하고 염소자리가 마무리하는 방식으로 진행하시기 바랍니다."),
        ("염소자리","토끼띠"):("돌아보면, 염소자리의 성실함과 토끼띠의 세심함이 만납니다. 정확하고 배려 있는 에너지가 흐르는 날입니다.", "이런 흐름이라면 함께 중요한 것을 꼼꼼하게 챙기기 가장 좋은 조합입니다."),
        ("염소자리","용띠"):  ("염소자리의 인내와 용띠의 카리스마가 만납니다. 큰 그림을 착실하게 실현하는 최고의 조합입니다.", "가능하다면 용띠의 큰 아이디어를 염소자리가 단계적으로 실현하는 계획을 세워보시기 바랍니다."),
        ("염소자리","뱀띠"):  ("오늘따라 두 신중한 에너지가 만납니다. 염소자리와 뱀띠 모두 깊이 생각하고 정확하게 움직이는 타입이라 함께하면 실수가 없습니다.", "지금이라면 중요한 결정을 함께 검토하기 가장 좋은 날입니다."),
        ...
        ("염소자리","원숭이띠"):("지금 이 흐름에서는 염소자리의 꾸준함과 원숭이띠의 창의성이 만납니다. 아이디어가 현실적으로 실현되는 최고의 조합입니다.", "한번 이렇게 해보면 좋습니다. 원숭이띠의 창의적 아이디어를 염소자리가 현실적으로 구체화하면 최고의 결과가 나옵니다."),
        ("염소자리","닭띠"):  ("가만히 보면, 두 꼼꼼한 에너지가 만납니다. 염소자리와 닭띠가 함께하면 실수 없이 목표를 달성하는 날입니다.", "이럴 때는 함께 중요한 것을 완성하기 가장 좋은 조합입니다."),
        ("염소자리","개띠"):  ("흥미롭게도 염소자리의 책임감과 개띠의 충성심이 만납니다. 서로를 믿고 함께 나아가는 최고의 조합입니다.", "오늘이라면 오래 함께 해온 목표를 다시 점검하기 좋은 날입니다."),
        ("염소자리","돼지띠"):("돌아보면, 염소자리의 성실함과 돼지띠의 낙천성이 만납니다. 열심히 하면서도 즐길 수 있는 에너지가 흐르는 날입니다.", "이런 흐름이라면 염소자리인 분이 돼지띠인 분의 낙천적 에너지에서 힘을 얻을 수 있습니다."),
        # 물병자리
        ("물병자리","쥐띠"):  ("두 빠른 두뇌 에너지가 만납니다. 물병자리의 혁신성과 쥐띠의 정보력이 결합하면 최고의 아이디어가 나옵니다.", "가능하다면 함께 브레인스토밍하기 가장 좋은 날입니다."),
        ("물병자리","소띠"):  ("오늘따라 물병자리의 혁신성과 소띠의 실행력이 만납니다. 새로운 아이디어가 현실이 되는 날입니다.", "지금이라면 물병자리의 혁신적 아이디어를 소띠가 착실하게 실현하면 최고의 결과가 나옵니다."),
        ...
        ("물병자리","용띠"):  ("지금 이 흐름에서는 두 강력한 혁신 에너지가 만납니다. 물병자리의 독창성과 용띠의 카리스마가 결합하면 세상을 바꾸는 힘이 생깁니다.", "한번 이렇게 해보면 좋습니다. 함께 큰 변화를 만들어가기 가장 좋은 날입니다."),
        ("물병자리","뱀띠"):  ("가만히 보면, 물병자리의 혁신성과 뱀띠의 깊은 통찰이 만납니다. 미래를 내다보는 최고의 조합입니다.", "이럴 때는 함께 장기적인 방향을 설계하기 가장 좋은 날입니다."),
        ("물병자리","말띠"):  ("흥미롭게도 두 자유로운 에너지가 만납니다. 물병자리와 말띠 모두 틀에 박히는 것을 싫어하는 타입이라 함께하면 새로운 가능성이 열립니다.", "오늘이라면 기존 방식에서 벗어나 새로운 것을 시도하기 가장 좋은 날입니다."),
        ("물병자리","양띠"):  ("돌아보면, 물병자리의 혁신성과 양띠의 감성이 만납니다. 새로운 것이 따뜻하게 전달되는 날입니다.", "이런 흐름이라면 물병자리의 아이디어를 양띠의 감성으로 표현하면 더 많은 사람의 마음에 닿습니다."),
        ("물병자리","원숭이띠"):("두 창의적인 에너지가 만납니다. 물병자리와 원숭이띠가 함께하면 아무도 생각하지 못한 해결책이 나오는 날입니다.", "가능하다면 자유롭게 아이디어를 나누면 최고의 결과가 나옵니다."),
        ...
        ("물고기자리","호랑이띠"):("흥미롭게도 물고기자리의 감성과 호랑이띠의 추진력이 만납니다. 마음이 행동으로 연결되는 강력한 날입니다.", "오늘이라면 물고기자리가 방향을 감지하고 호랑이띠가 실행하면 최고의 결과가 나옵니다."),
        ...
        ("물고기자리","닭띠"): ("가만히 보면, 물고기자리의 직관과 닭띠의 꼼꼼함이 만납니다. 감각과 정확함이 결합하는 최고의 조합입니다.", "이럴 때는 물고기자리의 직관적 아이디어를 닭띠가 꼼꼼하게 구체화하면 완벽한 결과가 나옵니다."),
        ("물고기자리","개띠"): ("흥미롭게도 물고기자리의 공감과 개띠의 충성심이 만납니다. 서로를 진심으로 아끼는 에너지가 빛나는 날입니다.", "오늘이라면 오래된 소중한 인연에게 마음을 전하기 가장 좋은 날입니다."),
