...
def main():
    ...
    body = (
        ...
        f"\"별빛이 오솔길로 내려오는 밤\"은 열두 별자리와 열두 띠가 한 편의 이야기 안에서 함께 만나는 "
        f"연재예요. 부업운·이사운·금전운·잠재력·재능·이번 달 좋은 점·조심해야 할 점, "
        f"이렇게 일곱 가지 흐름 속에서 하늘의 별자리와 오솔길의 띠가 번갈아 등장하며 이야기를 만들어가요.\n\n"
        f"이번 호에는 어떤 별자리와 띠가 등장해 어떤 이야기를 들려줄지, 부엉이 마을에 어떤 기운이 감돌고 "
        f"있는지 직접 확인해보세요. 카드나 순위 없이, 부엉이의 시선을 따라 자연스럽게 흘러가는 이야기로 "
        f"즐기실 수 있어요.\n\n"
        f"👉 {SITE_URL} 의 '별빛오솔길의 밤' 탭에서 이번 호를 만나보세요."
    )
